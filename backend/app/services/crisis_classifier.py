...
# severity ∈ {low, moderate, high, imminent} (use 'none' label → choose 'low')
# confidence ∈ [0,1]
# """

# USER_TEMPLATE = """Text: {text}
# Consider cultural context (Rwanda/East Africa) and slang where relevant.
...
#         data = json.loads(raw)
#     except Exception:
#         # fallback if LLM returned non-JSON
#         data = {"label": "other", "severity": "low", "confidence": 0.5, "rationale": raw}
#     # sanity defaults
...
# backend/app/services/crisis_classifier.py
