    ...
    async def execute(self, state: StatefulPipelineState) -> StatefulPipelineState:
        ...
        try:
            ...
            {{
                "confidence": 0.1,
                "keywords": [],
                "reasoning": "No crisis indicators detected with cultural context consideration",
                "severity": "none",
                "cultural_considerations": ["stigma_awareness", "indirect_expression"],
            ...
            logger.info(f"✅ Crisis detection completed: severity={crisis_assessment.crisis_severity.value}, confidence={crisis_assessment.crisis_confidence:.2f}, keywords={crisis_assessment.crisis_keywords}")
